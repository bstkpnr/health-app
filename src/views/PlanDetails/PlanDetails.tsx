...
const PlanDetails = () => {
  const leftColumnCards = [
    { number: '3', text: 'Ambulance', icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
    { number: '3', text: `Sağlık takip${`\n`}randevusu`, icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
    { number: '3', text: 'Transfer hizmeti', icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
  ];

  const rightColumnCards = [
    { number: '4/6', text: 'Telehealth', icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
    { number: '28', text: 'Danışma hattı', icon: Compass, iconBackgroundColor: '#CABDFF', iconPosition: 'right' },
    { number: '3', text: `Evde sağlık${`\n`}Hizmeti`, icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
    { number: '3', text: `Sağlık${`\n`}programları`, icon: Coffea, iconBackgroundColor: '#B1E5FC', iconPosition: 'right' },
  ];
            ...
            <View style={styles.usageDetailsContainer}>
              <View style={styles.usageItem}>
                <View style={styles.totalTextContainer}>
                  ...
                  <Text style={styles.usageText}>Online Uzman Dr.{'\n'}Görüşmesi</Text>
                </View>
              ...
              <View style={styles.usageItem}>
                <View style={styles.totalTextContainer}>
                  ...
                  <Text style={styles.usageText}>Transfer Hizmeti{'\n'}(Ev-Hastane)</Text>
                </View>
